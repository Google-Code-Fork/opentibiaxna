...
namespace OpenTibiaXna.OTServer.OpenTibia
{
    public class OtbmReader
    {
        ...
        public bool GetMapTiles(MapObject map)
        {
        ...
        private bool ParseTileArea(MapObject map, FileLoader loader, Node node)
        {
            PropertyReader props;
            if (!loader.GetProps(node, out props))
            {
            ...
            while (nodeTile != null)
            {
                    ...
                    nodeTile.Type == (long)OtbmNodeType.HouseTile)
                {
                    ...
                    tile.Location = new LocationEngine(tileX, tileY, tileZ);
                            ...
                            case OtbmAttribute.Item:
                                {
                                    ...
                                    ItemObject item = new ItemObject(itemId);
        ...
        private bool ParseTowns(MapObject map, FileLoader loader, Node node)
        {
            PropertyReader props;
            ...
            while (nodeTown != null)
            {
                ...
                TownObject town = new TownObject(
                    townid,
                    townName,
                    new LocationEngine(townTempleX, townTempleY, townTempleZ));
