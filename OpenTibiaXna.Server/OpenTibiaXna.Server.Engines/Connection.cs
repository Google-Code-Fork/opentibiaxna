...
namespace SharpOT
{
    public class Connection
    {
        ...
        public PlayerLocal Player { get; set; }
        ...
        private void ClientReadFirstCallBack(IAsyncResult ar)
        {
            ...
            if (protocol == 0x01)
            {
                ...
                Account account = Game.CheckAccount(this, accountPacket.Name, accountPacket.Password);
                ...
                if (account.AccountId >= 0)
                {
                    ...
                    SendCharacterList(
                        ...
                        999,
                        Database.GetCharacterList(account)
                    );
                }
        ...
        public void SendChannelList(PlayerLocal player)
        {
            NetworkMessage message = new NetworkMessage();
