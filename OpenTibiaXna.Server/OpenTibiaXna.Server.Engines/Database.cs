...
namespace SharpOT
{
    public class Database
    {
        ...
        public static Account GetAccount(string accountName, string password)
        {
            password = Util.Hash.SHA256Hash(password);

            Account account = (from results in 
                                  GenericEntities.CurrentContext.CreateQuery<Account>(typeof(Account).Name).Include(typeof(Player).Name)
                      where results.Name == accountName &&
        ...
        {
            return GetAccount(accountName, password).AccountId;
        }
        ...
        #region Players
        public static PlayerLocal GetPlayerByName(long accountId, string name)
        {
        ...
        public static PlayerLocal GetPlayerById(uint playerId)
        {
            PlayerLocal player = null;
            playerIdParam.Value = playerId;
        ...
        public static bool SavePlayerByName(PlayerLocal player)
        {
        ...
        public static bool SavePlayerById(PlayerLocal player)
        {
            PlayerInfoToParams(player);
        ...
        private static void PlayerInfoToParams(PlayerLocal player)
        {
        ...
        public static IEnumerable<PlayerLocal> GetAllPlayers()
        {
